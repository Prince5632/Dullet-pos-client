...
const VisitDetailsPage: React.FC = () => {
  ...
  const fetchVisit = async () => {
    try {
      ...
      setError(err?.message || err?.response?.data?.message || 'Failed to fetch visit details');
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center max-w-md mx-auto">
          ...
          <p className="text-gray-600 mb-6">{error || 'The visit you\'re looking for doesn\'t exist.'}</p>
          <button
  ...
  const currentStatusInfo = statusInfo[visit.status as keyof typeof statusInfo] || statusInfo.pending;
          ...
          <div className="lg:col-span-2 space-y-3 sm:space-y-4">
              ...
              <div className="p-3 sm:p-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div>
                    ...
                    <p className="text-sm text-gray-900">{formatDate(visit.scheduleDate)}</p>
                  </div>
                  <div>
                    <label className="text-xs font-medium text-gray-600 block mb-1">
                      Priority
                    </label>
                    <p className="text-sm text-gray-900 capitalize">{visit.priority || 'Normal'}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            {visit.capturedImage && (
              <div className="bg-white rounded-xl shadow-sm border border-gray-200">
                ...
                <div className="p-3 sm:p-4">
                  <button
                    onClick={() => handleViewImage(visit.capturedImage, 'Visit Image')}
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200">
              ...
              <div className="p-3 sm:p-4 space-y-3">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-xs font-medium text-gray-900 capitalize">{visit.type}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-xs text-gray-600">Created</span>
                  <span className="text-xs text-gray-900">{formatDate(visit.createdAt)}</span>
                </div>
                {visit.createdBy && (
                  <div className="flex justify-between items-center">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200">
              ...
              <div className="p-3 sm:p-4 space-y-3">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-xs font-medium text-gray-900">{visit.customer?.customerId}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-xs text-gray-600">Type</span>
                  <span className="text-xs text-gray-900 capitalize">{visit.customer?.customerType}</span>
                </div>
                {/* <div className="flex justify-between items-center">
            ...
            {visit.captureLocation && (
              <div className="bg-white rounded-xl shadow-sm border border-gray-200">
                ...
                <div className="p-3 sm:p-4 space-y-2">
                  <p className="text-xs text-gray-700">{visit.captureLocation.address}</p>
